...
import { LayoutGrid, BarChart3, Map as MapIcon, Activity, Radio } from 'lucide-react';
...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground selection:bg-primary/30">
      {/* ─── Top Navigation Bar ─── */}
      <header className="h-16 flex-shrink-0 border-b border-border/50 bg-white/70 backdrop-blur-xl sticky top-0 z-50 px-6">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-bold tracking-[0.4em] text-primary/80 uppercase mt-0.5">
                  Kinetic Observatory
                </span>
              </div>
            </Link>
